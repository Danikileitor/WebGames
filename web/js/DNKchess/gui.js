...
function PreSearch() {
	...
	if (GameController.GameOver != BOOL.TRUE) {
		...
		$('#ThinkingImageDiv').append('<image src="assets/DNKchess/images/think3.png" id="ThinkingPng"/>')
...
function AddGUIPiece(sq, pce) {
	...
	pieceFileName = "assets/DNKchess/images/" + SideChar[PieceCol[pce]] + PceChar[pce].toUpperCase() + ".png";
